...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', 'target_ip'], name='shared_mode_user_id_1a2b53_idx'), models.Index(fields=['mongo_object_id'], name='shared_mode_mongo_o_d6d76c_idx')],
            },
        ),
    ]
